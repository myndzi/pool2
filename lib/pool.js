...
function Pool(opts) { // jshint ignore: line
    ...
    opts.disposeTimeout = parseInt(opts.disposeTimeout, 10);
    ...
    this.disposeTimeout = !isNaN(opts.disposeTimeout) ? opts.acquireTimeout : 30 * 1000;
...
Pool.prototype.remove = function (res, cb) {
    ...
    var timer = setTimeout(this.destroy.bind(this, res), this.disposeTimeout);
